...
# KOMPLETNA WERSJA: Masking + Anchors + Auto-Split
QLORA_CONTENT = r'''import os
import platform
...
if __name__ == "__main__":
    fix_file("src/scriptguard/models/qlora_finetuner.py", QLORA_CONTENT)
    print("\n🚀 Kod naprawiony. Teraz MUSI zadziałać ewaluacja.")